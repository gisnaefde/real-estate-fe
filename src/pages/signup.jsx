                ...
                <div className='grid grid-cols-1 md:grid-cols-2 relative '>
                    ...
                    <div className='bg-white text-green py-14 rounded-xl md:rounded-r-2xl'>
                        <div className='text-center'>
                            ...
                            <p className=''>Please SignUp to Continue</p>
                        </div>
                        <div className='px-7 md:px-20'>
                            <form className=' mt-6 flex flex-col space-y-5'>
                                ...
                                <input type='password' placeholder='password confirm' className='px-4 py-2 rounded-lg border-gray400 text-gray400 border border-gray-300 focus:outline-none focus:border-gray400 focus:border-2'></input>
